    ...
    if (filteredGames.length > 0) {
        dropdown.innerHTML = filteredGames.map(game => `
            <a href="${game.slug}" class="search-result-item">
                <img src="assets/${(game.slug === 'index' || game.slug === '/') ? '1v1-lol' : game.slug}.webp" onerror="this.src='assets/hero.webp'">
...
function goToRandomGame() {
    ...
    if (otherGames.length > 0) {
        ...
        // Fallback to root if something is wrong
...
function renderFavorites() {
    ...
    grid.innerHTML = favorites.map(game => {
        ...
        const imgName = (game.slug === 'index' || game.slug === '/') ? '1v1-lol' : game.slug.replace('.html', '');
        return `
...
document.addEventListener("DOMContentLoaded", (() => {
    ...
    window.addEventListener("scroll", (() => {
        window.pageYOffset > 300 ? e.classList.add("show") : e.classList.remove("show")
    }));
