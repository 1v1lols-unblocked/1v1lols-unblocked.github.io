// Throttle helper to improve scroll performance
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Set dynamic blurred background for game container
    ...
    if (gameContainer && previewImg) {
        ...
        // Update if src changes (e.g. onerror)
...
function renderFavorites() {
    ...
    grid.innerHTML = favorites.map(game => {
        // Fix for 1v1.lol thumbnail in favorites
        const imgName = game.slug === 'index' ? '1v1-lol' : game.slug.replace('.html', '');
        return `
